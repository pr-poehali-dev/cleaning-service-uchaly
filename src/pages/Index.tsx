        ...
        <div className="container grid items-center gap-12 py-16 md:grid-cols-2 md:py-24">
          <div className="animate-fade-in">
            ...
            <div className="mt-10 flex gap-8">
              <div>
                <div className="font-display text-3xl font-extrabold text-primary">3 года</div>
            ...
            <div className="mt-8 space-y-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="font-display text-lg font-bold">г. Учалы, ул. Имангуловская, 516</div>
                </div>
              </div>
            </div>
